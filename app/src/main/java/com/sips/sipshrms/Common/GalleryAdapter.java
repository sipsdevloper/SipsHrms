...
public class GalleryAdapter extends RecyclerView.Adapter<GalleryAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        Log.i("MMMMMMMMMMMMM", ((GalleryActivity)mContext).urlgalleryimage+image.getImage_name());
        Glide.with(mContext).load(((GalleryActivity)mContext).urlgalleryimage+image.getImage_name())
                .thumbnail(0.5f)
                .crossFade()
